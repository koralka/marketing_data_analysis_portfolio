...
def fetch_data_from_sql():
    ...
    conn_str = (
        ...
        "Server=DESKTOP-2LBRR89\SQLEXPRESS;"  # Specify your SQL Server instance
...
# Initialise the VADER sentiment analyzer for analysing the sentiment of text data
sia = SentimentIntensityAnalyzer()

# Define a function to calculate sentiment scored using VADER
def calculate_sentiment(review):
    # Get the sentiment scores fro the review text
    sentiment = sia.polarity_scores(review)
    # Return the compound score, which is a normalised score between -1 (most negative) and 1 (most positive)
    return sentiment['compound']

# Define a function that categorises sentiment using both the sentiment score and the review rating
...
# Define a function to bucket sentiment scored into text ranges:
...
# Apply sentiment bucketing to categorise scores into defined ranges
